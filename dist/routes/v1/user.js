...
}), (0, express_validator_1.body)('password').optional().isString().isLength({ min: 8 }).withMessage('Password must be at least 8 characters long'), (0, express_validator_1.body)(['first_name', 'last_name']).optional().isString().withMessage('Name must be  less than 50 characters').isLength({ max: 50 }), validationError_1.default, update_current_user_1.default);
...
router.get('/:id', authenticate_1.default, (0, authorize_1.default)(['admin']), (0, express_validator_1.param)('id').notEmpty().isMongoId().withMessage('Invalid user ID format'), validationError_1.default, get_user_by_id_1.default);
